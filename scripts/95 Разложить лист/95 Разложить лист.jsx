...
(function () {
    ...
    alert(
        "Готово!\n" +
        "Лист 1 (+" + OFFSET_MM + " мм) — верхний слой (обтравка) каждого объекта.\n" +
        "Лист 2 — слой под ним и т.д.\n" +
        "Если у объекта слоёв меньше, на лишних листах берётся его нижняя обтравка."
    );
})();
